---
description: Руководство по переходу на apisdkopti24 3.x, строгие модели, lifecycle и бюджет выполнения.
---
...
!!! info "Релизная версия"
    Публичный контракт этого руководства соответствует `apisdkopti24 3.3.2`.
