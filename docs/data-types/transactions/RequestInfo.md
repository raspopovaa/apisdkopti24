---
description: "Информация о типе и названии запроса."
---
# `RequestInfo`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `type` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | Тип операции (например, Advice) |
| `name` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | Название операции (например, Покупка) |
