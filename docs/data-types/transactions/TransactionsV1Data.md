...
| `result` | `list[TransactionV1] \| None` | `array[object (TransactionV1)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[TransactionV1], None | Список транзакций |
...
- [`TransactionV1`](TransactionV1.md)
