---
description: "Поля и правила Pydantic-валидации модели TransactionsV1Response."
---
...
| `data` | `TransactionsV1Data` | `object (TransactionsV1Data)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью TransactionsV1Data. | Типизированные данные ответа API |
...
- [`TransactionsV1Data`](TransactionsV1Data.md)
