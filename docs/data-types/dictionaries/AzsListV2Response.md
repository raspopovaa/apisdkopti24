---
description: "Ответ метода получения списка торговых точек (v2)"
---
# `AzsListV2Response`
...
| `data` | `AzsListV2Data \| None` | `object (AzsListV2Data) \| null` | Да | Да | `—` | `—` | — | Значение должно соответствовать одному из типов: AzsListV2Data, None | Типизированные данные ответа API |
