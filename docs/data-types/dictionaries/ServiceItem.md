---
description: "Описание отдельной услуги"
---
# `ServiceItem`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `name` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | Наименование услуги |
| `code` | `int \| str` | `integer \| string` | Да | Нет | `—` | `—` | — | Значение должно соответствовать одному из типов: int, str | Код услуги (числовой или строковый) |
