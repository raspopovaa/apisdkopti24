...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `name` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Наименование услуги |
| `code` | `int \| str \| None` | `integer \| string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: int, str, None | Код услуги (числовой или строковый) |
| `sort` | `int \| None` | `integer \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: int, None | Порядок сортировки |
