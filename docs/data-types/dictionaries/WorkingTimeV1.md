---
description: "Рабочее время торговой точки"
---
# `WorkingTimeV1`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `Weekday` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | День недели или режим работы |
| `StartWorkTime` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Время открытия |
| `FinishWorkTime` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Время закрытия |
