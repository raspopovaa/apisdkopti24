...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `name` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Наименование группы услуг |
| `items` | `list[ServiceItem] \| None` | `array[object (ServiceItem)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[ServiceItem], None | Список услуг, входящих в группу |
