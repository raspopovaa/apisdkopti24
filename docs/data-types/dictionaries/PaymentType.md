---
description: "Способ оплаты, доступный на торговой точке."
---
# `PaymentType`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `code` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Код способа оплаты |
| `name` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Название способа оплаты |
