...
| `result` | `list[DictionaryItem] \| None` | `array[object (DictionaryItem)] \| null` | Нет | Да | `фабрика: list()` | `—` | — | Значение должно соответствовать одному из типов: list[DictionaryItem], None | Список элементов справочника |
