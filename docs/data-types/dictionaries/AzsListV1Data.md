...
| `result` | `list[AzsItemV1] \| None` | `array[object (AzsItemV1)] \| null` | Нет | Да | `фабрика: list()` | `—` | — | Значение должно соответствовать одному из типов: list[AzsItemV1], None | Список торговых точек |
