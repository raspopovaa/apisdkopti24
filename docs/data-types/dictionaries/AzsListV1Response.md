...
| `data` | `AzsListV1Data \| None` | `object (AzsListV1Data) \| null` | Да | Да | `—` | `—` | — | Значение должно соответствовать одному из типов: AzsListV1Data, None | Типизированные данные ответа API |
...
- [`AzsListV1Data`](AzsListV1Data.md)
