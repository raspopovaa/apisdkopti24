...
| `data` | `list[AzsFilterItem] \| None` | `array[object (AzsFilterItem)] \| null` | Да | Да | `—` | `—` | — | Значение должно соответствовать одному из типов: list[AzsFilterItem], None | Типизированные данные ответа API |
