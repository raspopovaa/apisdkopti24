---
description: "Поля и правила Pydantic-валидации модели AuthUserResponse."
---
# `AuthUserResponse`
...
| `data` | `AuthUserData` | `object (AuthUserData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью AuthUserData. | Типизированные данные ответа API |
