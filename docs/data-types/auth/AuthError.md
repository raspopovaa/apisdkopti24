---
description: "Поля и правила Pydantic-валидации модели AuthError."
---
# `AuthError`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `code` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | Код ошибки (например, INVALID_CREDENTIALS) |
| `message` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | Текст ошибки |
