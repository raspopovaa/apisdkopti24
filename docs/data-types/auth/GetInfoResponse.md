---
description: "Поля и правила Pydantic-валидации модели GetInfoResponse."
---
# `GetInfoResponse`
...
| `data` | `InfoData` | `object (InfoData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью InfoData. | Типизированные данные ответа API |
