---
description: "Поля и правила Pydantic-валидации модели AccessRights."
---
# `AccessRights`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `web` | `bool` | `boolean` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как bool. | Доступ к ЛК |
| `api` | `bool` | `boolean` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как bool. | Доступ к API |
| `mobile` | `bool` | `boolean` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как bool. | Доступ к МП |
