---
description: "Поля и правила Pydantic-валидации модели StatusResponse."
---
# `StatusResponse`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `code` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Код состояния ответа (например, 200 — OK, 400 — ошибка запроса) |
