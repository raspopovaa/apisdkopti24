---
description: "Поля и правила Pydantic-валидации модели MethodsInfo."
---
# `MethodsInfo`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `actions_bill` | `dict[str, str]` | `object[string, string]` | Да | Нет | `—` | `—` | — | Проверяется как объект: ключи str, значения str. | Платные методы API (влияют на статистику) |
| `actions_not_bill` | `dict[str, str]` | `object[string, string]` | Да | Нет | `—` | `—` | — | Проверяется как объект: ключи str, значения str. | Бесплатные методы API (не влияют на статистику) |
