---
description: "Поля и правила Pydantic-валидации модели AuthErrorResponse."
---
# `AuthErrorResponse`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `error` | `AuthError` | `object (AuthError)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью AuthError. | Описание ошибки авторизации |
