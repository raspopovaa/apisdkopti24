...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `date_start` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | — |
| `date_end` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | — |
| `page` | `int` | `integer` | Нет | Нет | `1` | `—` | — | Значение преобразуется и проверяется как int. | — |
| `on_page` | `int` | `integer` | Нет | Нет | `10` | `—` | — | Значение преобразуется и проверяется как int. | — |
