---
description: "Список товарных ограничителей."
---
# `RestrictionList`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `total_count` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Общее количество ограничителей |
| `result` | `list[RestrictionItem] \| None` | `array[object (RestrictionItem)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[RestrictionItem], None | Список ограничителей |
...
- [`RestrictionItem`](RestrictionItem.md)
