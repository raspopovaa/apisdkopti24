...
| `result` | `list[RestrictionItem]` | `array[object (RestrictionItem)]` | Да | Нет | `—` | `—` | — | Проверяется как список; каждый элемент проверяется как RestrictionItem. | Список ограничителей |
