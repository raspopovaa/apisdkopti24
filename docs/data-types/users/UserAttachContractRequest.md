---
description: "Договор, прикрепляемый к пользователю."
---
...
| `template_id` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | ID шаблона виртуальной карты |
| `use_mpc` | `bool \| None` | `boolean \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: bool, None | Разрешён ли выпуск МПК |
