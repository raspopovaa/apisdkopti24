---
description: "Поля и правила Pydantic-валидации модели UserListResponse."
---
# `UserListResponse`
...
| `data` | `UserList \| None` | `object (UserList) \| null` | Да | Да | `—` | `—` | — | Значение должно соответствовать одному из типов: UserList, None | Типизированные данные ответа API |
