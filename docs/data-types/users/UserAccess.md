...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `web` | `bool` | `boolean` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как bool. | Доступ через веб-интерфейс |
| `api` | `bool` | `boolean` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как bool. | Доступ через API |
| `mobile` | `bool` | `boolean` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как bool. | Доступ через мобильное приложение |
