---
description: "Информация о созданной или изменённой группе."
---
# `SetCardGroupData`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `id` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | Идентификатор созданной или изменённой группы |
