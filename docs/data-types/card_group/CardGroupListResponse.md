---
description: "Ответ метода получения списка групп карт."
---
...
| `data` | `CardGroupListData` | `object (CardGroupListData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью CardGroupListData. | Типизированные данные ответа API |
...
- [`CardGroupListData`](CardGroupListData.md)
