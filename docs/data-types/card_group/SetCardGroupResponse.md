---
description: "Ответ метода установки/изменения группы карт."
---
...
| `data` | `SetCardGroupData` | `object (SetCardGroupData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью SetCardGroupData. | Типизированные данные ответа API |
...
- [`SetCardGroupData`](SetCardGroupData.md)
