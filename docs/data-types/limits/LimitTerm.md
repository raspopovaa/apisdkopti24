...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `days` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Дни недели (например, '1111100' для Пн–Пт) |
| `type` | `int \| None` | `integer \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: int, None | Тип периода (1 — будни, 2 — ежедневно и т.д.) |
| `time` | `LimitTermTime \| None` | `object (LimitTermTime) \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: LimitTermTime, None | Временной диапазон действия |
