---
description: "Ответ на запрос списка лимитов."
---
# `LimitsResponse`
...
| `data` | `LimitsData` | `object (LimitsData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью LimitsData. | Типизированные данные ответа API |
