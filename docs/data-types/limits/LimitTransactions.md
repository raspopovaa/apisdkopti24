...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `count` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Максимальное количество транзакций |
| `occured` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Фактическое количество транзакций |
