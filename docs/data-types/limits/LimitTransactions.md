...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `count` | `int \| None` | `integer \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: int, None | Максимальное количество транзакций |
| `occured` | `int \| None` | `integer \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: int, None | Фактическое количество транзакций |
