...
| `result` | `list[LimitItem] \| None` | `array[object (LimitItem)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[LimitItem], None | Список лимитов |
