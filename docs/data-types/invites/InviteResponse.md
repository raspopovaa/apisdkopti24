...
| `data` | `InviteActionResult` | `object (InviteActionResult)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью InviteActionResult. | Типизированные данные ответа API |
...
- [`InviteActionResult`](InviteActionResult.md)
