---
description: "Ответ на запрос списка приглашений"
---
# `InviteList`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `total_count` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Общее количество приглашений |
| `result` | `list[InviteItem] \| None` | `array[object (InviteItem)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[InviteItem], None | Список приглашений |
