---
description: "Ответ со списком выпущенных мобильных профилей."
---
# `MPCListResponse`
...
| `data` | `MPCListData` | `object (MPCListData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью MPCListData. | Типизированные данные ответа API |
