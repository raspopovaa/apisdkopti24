---
description: "Ответ генерации платёжной строки для отображения как QR-код."
---
# `PaymentQRResponse`
...
| `data` | `PaymentQRData` | `object (PaymentQRData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью PaymentQRData. | Типизированные данные ответа API |
...
- [`PaymentQRData`](PaymentQRData.md)
