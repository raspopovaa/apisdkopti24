---
description: "Поля и правила Pydantic-валидации модели StatusModel."
---
# `StatusModel`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `code` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Код статуса ответа (200 — успешно, иное — ошибка) |
| `errors` | `list[dict[str, object]] \| None` | `array[object] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[dict[str, object]], None | Массив ошибок операции |
