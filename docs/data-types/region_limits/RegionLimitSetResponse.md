---
description: "Полный envelope установки или изменения региональных лимитов."
---
...
| `data` | `list[str] \| None` | `array[string] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[str], None | ID сохранённых региональных лимитов |
