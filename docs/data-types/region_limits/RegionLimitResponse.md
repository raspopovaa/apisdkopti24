...
| `data` | `RegionLimitList` | `object (RegionLimitList)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью RegionLimitList. | Типизированные данные ответа API |
...
- [`RegionLimitList`](RegionLimitList.md)
