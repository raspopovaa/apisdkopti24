---
description: "Коллекция региональных лимитов."
---
# `RegionLimitList`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `total_count` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Общее количество лимитов |
| `result` | `list[RegionLimit] \| None` | `array[object (RegionLimit)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[RegionLimit], None | Данные с лимитами |
