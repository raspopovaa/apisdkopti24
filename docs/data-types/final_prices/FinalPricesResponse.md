---
description: "Ответ метода получения финальных цен на АЗС"
---
# `FinalPricesResponse`
...
| `data` | `FinalPricesData` | `object (FinalPricesData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью FinalPricesData. | Типизированные данные ответа API |
...
- [`FinalPricesData`](FinalPricesData.md)
