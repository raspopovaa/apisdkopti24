...
| `data` | `ReportJobList` | `object (ReportJobList)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью ReportJobList. | Типизированные данные ответа API |
...
- [`ReportJobList`](ReportJobList.md)
