---
description: "Данные созданного задания отчёта (v2)."
---
# `ReportOrderData`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `job_id` | `list[str] \| None` | `array[string] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[str], None | Идентификаторы созданных заданий на генерацию отчета |
