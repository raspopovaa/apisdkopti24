---
description: "Полный envelope заказа отчёта (v2)."
---
# `ReportOrderResponse`
...
| `data` | `ReportOrderData` | `object (ReportOrderData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью ReportOrderData. | Типизированные данные ответа API |
...
- [`ReportOrderData`](ReportOrderData.md)
