---
description: "Значения меню для параметра отчета."
---
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `labels` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Отображаемое имя пункта меню |
| `values` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Значение пункта меню |
