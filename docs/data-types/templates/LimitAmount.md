...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `unit` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Единица измерения (например, 'LIT') |
| `value` | `float \| None` | `number \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: float, None | Количество или объем в единицах измерения |
