---
description: "Поля и правила Pydantic-валидации модели LimitTermTime."
---
# `LimitTermTime`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `from_` | `str \| None` | `string \| null` | Нет | Да | `None` | `from` | — | Значение должно соответствовать одному из типов: str, None | Начало временного диапазона (например, '03:00') |
| `to` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Конец временного диапазона (например, '08:00') |
