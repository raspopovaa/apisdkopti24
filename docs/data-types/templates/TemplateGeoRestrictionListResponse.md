---
description: "Поля и правила Pydantic-валидации модели TemplateGeoRestrictionListResponse."
---
...
| `data` | `TemplateGeoRestrictionListData` | `object (TemplateGeoRestrictionListData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью TemplateGeoRestrictionListData. | Типизированные данные ответа API |
...
- [`TemplateGeoRestrictionListData`](TemplateGeoRestrictionListData.md)
