...
| `result` | `list[TemplateItem]` | `array[object (TemplateItem)]` | Да | Нет | `—` | `—` | — | Проверяется как список; каждый элемент проверяется как TemplateItem. | Список найденных шаблонов ВК |
