---
description: "Поля и правила Pydantic-валидации модели TemplateLimitListResponse."
---
...
| `data` | `TemplateLimitListData` | `object (TemplateLimitListData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью TemplateLimitListData. | Типизированные данные ответа API |
...
- [`TemplateLimitListData`](TemplateLimitListData.md)
