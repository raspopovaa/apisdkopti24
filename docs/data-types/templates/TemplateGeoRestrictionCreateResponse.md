---
description: "Поля и правила Pydantic-валидации модели TemplateGeoRestrictionCreateResponse."
---
...
| `data` | `str` | `string` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как str. | Типизированные данные ответа API |
