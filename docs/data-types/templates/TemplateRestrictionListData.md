---
description: "Поля и правила Pydantic-валидации модели TemplateRestrictionListData."
---
...
| `result` | `list[TemplateRestriction] \| None` | `array[object (TemplateRestriction)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[TemplateRestriction], None | Список ограничителей шаблона |
