...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `currency` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Код валюты (например, '810') |
| `currencyName` | `str \| None` | `string \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: str, None | Название валюты (например, 'р.') |
| `value` | `float \| None` | `number \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: float, None | Сумма лимита в указанной валюте |
