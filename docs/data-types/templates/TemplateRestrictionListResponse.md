---
description: "Поля и правила Pydantic-валидации модели TemplateRestrictionListResponse."
---
...
| `data` | `TemplateRestrictionListData` | `object (TemplateRestrictionListData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью TemplateRestrictionListData. | Типизированные данные ответа API |
...
- [`TemplateRestrictionListData`](TemplateRestrictionListData.md)
