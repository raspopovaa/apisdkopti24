---
description: "Поля и правила Pydantic-валидации модели TemplateLimitListData."
---
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `total_count` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Количество найденных лимитов |
| `result` | `list[TemplateLimit] \| None` | `array[object (TemplateLimit)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[TemplateLimit], None | Список лимитов шаблона |
...
- [`TemplateLimit`](TemplateLimit.md)
