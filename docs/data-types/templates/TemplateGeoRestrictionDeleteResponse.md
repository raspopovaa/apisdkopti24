---
description: "Поля и правила Pydantic-валидации модели TemplateGeoRestrictionDeleteResponse."
---
...
| `data` | `bool` | `boolean` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как bool. | Типизированные данные ответа API |
