---
description: "Поля и правила Pydantic-валидации модели IDListResponse."
---
# `IDListResponse`
...
| `data` | `list[str] \| None` | `array[string] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[str], None | Список идентификаторов обработанных карт |
