---
description: "Поля и правила Pydantic-валидации модели TransactionTimeout."
---
# `TransactionTimeout`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `type` | `int \| str \| None` | `integer \| string \| null` | Да | Да | `—` | `—` | — | Значение должно соответствовать одному из типов: int, str, None | Тип таймаута ('H', 'N' или числовое значение) |
| `value` | `int \| str` | `integer \| string` | Да | Нет | `—` | `—` | — | Значение должно соответствовать одному из типов: int, str | Значение таймаута |
