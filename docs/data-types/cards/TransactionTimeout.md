...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `type` | `str \| int` | `string \| integer` | Да | Нет | `—` | `—` | — | Значение должно соответствовать одному из типов: str, int | Тип таймаута ('H', 'N' или числовое значение) |
| `value` | `str \| int` | `string \| integer` | Да | Нет | `—` | `—` | — | Значение должно соответствовать одному из типов: str, int | Значение таймаута |
