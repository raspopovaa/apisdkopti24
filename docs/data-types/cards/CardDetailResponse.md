---
description: "Поля и правила Pydantic-валидации модели CardDetailResponse."
---
# `CardDetailResponse`
...
| `data` | `CardDetailData` | `object (CardDetailData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью CardDetailData. | Типизированные данные ответа API |
...
- [`CardDetailData`](CardDetailData.md)
