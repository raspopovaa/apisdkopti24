---
description: "Поля и правила Pydantic-валидации модели SetCardCommentRequest."
---
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `card_id` | `str` | `string` | Да | Нет | `—` | `—` | минимальная длина: 1 | Значение преобразуется и проверяется как str. | — |
| `contract_id` | `str` | `string` | Да | Нет | `—` | `—` | минимальная длина: 1 | Значение преобразуется и проверяется как str. | — |
| `comment` | `str` | `string` | Да | Нет | `—` | `—` | минимальная длина: 1 | Значение преобразуется и проверяется как str. | — |
