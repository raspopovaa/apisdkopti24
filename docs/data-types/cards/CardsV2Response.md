...
| `data` | `CardsV2Data` | `object (CardsV2Data)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью CardsV2Data. | Типизированные данные ответа API |
