---
description: "Поля и правила Pydantic-валидации модели CardGroupResponse."
---
# `CardGroupResponse`
...
| `data` | `CardGroupData` | `object (CardGroupData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью CardGroupData. | Типизированные данные ответа API |
...
- [`CardGroupData`](CardGroupData.md)
