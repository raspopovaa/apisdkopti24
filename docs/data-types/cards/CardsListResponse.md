---
description: "Поля и правила Pydantic-валидации модели CardsListResponse."
---
# `CardsListResponse`
...
| `data` | `CardsListData` | `object (CardsListData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью CardsListData. | Типизированные данные ответа API |
