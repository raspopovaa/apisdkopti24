---
description: "Поля и правила Pydantic-валидации модели CardDriversData."
---
# `CardDriversData`
...
|---|---|---|:---:|:---:|---|---|---|---|---|
| `total_count` | `int` | `integer` | Да | Нет | `—` | `—` | — | Значение преобразуется и проверяется как int. | Количество водителей, связанных с картой |
| `result` | `list[CardDriverInfo] \| None` | `array[object (CardDriverInfo)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[CardDriverInfo], None | Список водителей |
...
- [`CardDriverInfo`](CardDriverInfo.md)
