---
description: "Поля и правила Pydantic-валидации модели CardsListData."
---
# `CardsListData`
...
| `result` | `list[CardInfo] \| None` | `array[object (CardInfo)] \| null` | Нет | Да | `None` | `—` | — | Значение должно соответствовать одному из типов: list[CardInfo], None | Список найденных карт |
