---
description: "Поля и правила Pydantic-валидации модели CardDriversResponse."
---
# `CardDriversResponse`
...
| `data` | `CardDriversData` | `object (CardDriversData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью CardDriversData. | Типизированные данные ответа API |
...
- [`CardDriversData`](CardDriversData.md)
