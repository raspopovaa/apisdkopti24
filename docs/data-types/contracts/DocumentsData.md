...
| `result` | `list[DocumentItem]` | `array[object (DocumentItem)]` | Да | Нет | `—` | `—` | — | Проверяется как список; каждый элемент проверяется как DocumentItem. | Список найденных документов |
