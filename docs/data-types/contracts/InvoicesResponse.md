...
| `data` | `InvoicesData` | `object (InvoicesData)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью InvoicesData. | Типизированные данные ответа API |
