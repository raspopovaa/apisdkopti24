---
description: "Полный envelope ответа метода получения данных договора."
---
...
| `data` | `ContractResponse` | `object (ContractResponse)` | Да | Нет | `—` | `—` | — | Вложенный объект рекурсивно проверяется моделью ContractResponse. | Типизированные данные ответа API |
