---
description: Правила версионирования SDK apisdkopti24 и публикации документации через Mike и GitHub Pages.
---

# Версионирование документации

Документация публикуется по линиям `major.minor`. Для SDK 3.3.3 используется
каталог `3.3`, а alias `latest` перенаправляет на текущую линию.

Примеры URL:

- `/apisdkopti24/3.3/` — документация линии 3.3;
...
2. Обновите примеры, CHANGELOG и сведения о совместимости.
