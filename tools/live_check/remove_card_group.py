"""remove_card_group — Удаление группы карт

Что делает
    Удаляет группу карт. Передаёт group_id и contract_id, выводит envelope результата.
    Изменяет данные: да. Тарификация: да. Демо-стенд: да.
    Вызов SDK: client.card_groups.remove_card_group(...)
    Раздел спецификации 1.1.60: Удаление группы карт
...
DESCRIPTION = 'Удаляет группу карт. Передаёт group_id и contract_id, выводит envelope результата.'

if __name__ == "__main__":
    run('remove_card_group', PARAMS, mutating=True, description=DESCRIPTION)
